...
export const translations = {
  es: {
    ...
    track_subtitle: 'Track record auditado públicamente en Darwinex Zero.',
    track_link: 'Ver auditoría',
    track_return: 'Rentabilidad',
    track_annual_return: 'Rentabilidad anualizada',
    track_drawdown: 'Drawdown',
    track_sharpe: 'Ratio de Sharpe',
    track_sortino: 'Ratio de Sortino',
    track_volatility: 'Volatilidad anualizada',
    track_cmh: 'CMH',
    track_return_since_cmh: 'Desde CMH',
    track_years: 'Años',
  ...
  en: {
    ...
    track_subtitle: 'Publicly audited track record on Darwinex Zero.',
    track_link: 'View audit',
    track_return: 'Return',
    track_annual_return: 'Annualized return',
    track_drawdown: 'Drawdown',
    track_sharpe: 'Sharpe ratio',
    track_sortino: 'Sortino ratio',
    track_volatility: 'Annualized volatility',
    track_cmh: 'ATH quote',
    track_return_since_cmh: 'Since ATH',
    track_years: 'Years',
